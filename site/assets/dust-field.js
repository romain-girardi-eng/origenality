/* Origenality — explorer dust.
   ...
   sampling adapted from the project's earlier personal-graph engine.
   Graph-node path only: no wordmark morph, no edge filaments.
   Romain Girardi, 2026. */

import * as THREE from './vendor/three.module.min.js?v=08fd7545';
import { GPUComputationRenderer } from './vendor/GPUComputationRenderer.js?v=ce85b2c8';
...
// Explorer language colours, fed into the inherited palette slots.
const PALETTE = {
  lapis: hex01('#1F5674'),
  gold: hex01('#8A6A12'),
  red: hex01('#A8371F'),
